...
- (void)viewDidLoad {
    ...
    CQTSRipeButtonCollectionView *horizontalCollectionView = [[CQTSRipeButtonCollectionView alloc] initWithTitles:buttonTitles perMaxCount:1 widthHeightRatio:88/44.0 scrollDirection:UICollectionViewScrollDirectionHorizontal didSelectItemAtIndexHandle:^(NSInteger index) {
...
//        }
    ...
    CQTSRipeButtonCollectionView *verticalCollectionView = [[CQTSRipeButtonCollectionView alloc] initWithTitles:buttonTitles perMaxCount:1 widthHeightRatio:88/44.0 scrollDirection:UICollectionViewScrollDirectionVertical didSelectItemAtIndexHandle:^(NSInteger index) {
        NSString *title = buttonTitles[index];
        NSLog(@"点击了“%@”", title);
    }];
