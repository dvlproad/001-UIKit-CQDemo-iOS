...
public class NSClassFromStringCJHelper: NSObject {
    // className:想要转换类名的字符串
    @objc public class func controllerFormString(className: String, isOC:Bool = false, nameSpace: String = "") -> UIViewController{
